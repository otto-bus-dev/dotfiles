...
install_nvidia_driver() {
    ...
    sudo ln -s ~/dotfiles/install/graphics/mkinitcpio.nvidia.conf /etc/mkinitcpio.conf
}
...
install_intel_driver() {
    ...
    sudo ln -s ~/dotfiles/install/graphics/mkinitcpio.intel.conf /etc/mkinitcpio.conf
}
